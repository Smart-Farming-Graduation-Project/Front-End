...
const Sidebar = () => {
  ...
  return (
    <div className={`p-2 bg-gradient-to-r from-[#033d20] to-green shadow-lg transition-all duration-300 ${isSidebarOpen ? "w-56" : "w-[72px]"} ${isMobile && isSidebarOpen ? "absolute top-0 left-0 z-50 min-h-screen" : "relative"}`}>
